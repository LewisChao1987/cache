 ...
 * @创建时间: 2022-03-15
 */
public class ProvinceStageSchemeVO {
    /**
     * 方案id
     */
    ...
    private List<ProvinceStageSchemeDtl>provinceStageSchemeDtlList;
    ...
    public List<ProvinceStageSchemeDtl> getProvinceStageSchemeDtlList() {
        return provinceStageSchemeDtlList;
    }

    public void setProvinceStageSchemeDtlList(List<ProvinceStageSchemeDtl> provinceStageSchemeDtlList) {
        this.provinceStageSchemeDtlList = provinceStageSchemeDtlList;
    }
